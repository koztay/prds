# -*- coding: utf-8 -*-
"""
Django settings for karnas-cookiecutter project.
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            str(ROOT_DIR.path('templates')),  # buradaki sıralama önemli, override etmek için önce
...
# bu durumda STATIC_ROOT = /usr/src/static_in_env olmalı
STATIC_ROOT = os.path.join(os.path.dirname(ROOT_DIR), "static_in_env", "static_root")
...
# MEDIA_URL = '/media/'
MEDIA_URL = '/media/'
MEDIA_ROOT = os.path.join(os.path.dirname(ROOT_DIR), "static_in_env", "media_root")
